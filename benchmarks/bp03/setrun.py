...
#------------------------------
    ...
    if clawdata.outstyle==1:
        ...
        clawdata.tout =  np.linspace(0,2,40)
        #clawdata.tout.append(10)
    ...
    clawdata.auxtype = ['center','center','center']
...
#-------------------
    ...
    #geodata.dtopofiles.append([1,3,3,'block1.txydz'])
