...
Section 7.3.1 of \cite{rjl:fvmhp}.  
...
right-going wave with Riemann invariant $u - 2\sqrt{gh}$ and the value of
this should be constant through the wave, and hence equal to $-2\sqrt{gh_0}$
