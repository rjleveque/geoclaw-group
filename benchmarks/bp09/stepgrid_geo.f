...
c     # see if any f-grids should be written out
      write(6,*) 'mfgrids = ',mfgrids
      do ng=1,mfgrids
c       write(6,*) "tc0,tstartfg(ng),ilastoutfg(ng),noutfg(ng):"
        write(6,*) tc0,tstartfg(ng),ilastoutfg(ng),noutfg(ng)
...
c     # since tc0> output time
           do ioutfg=ioutfgstart,ioutfgend
             ...
             write(45,*) "+++toutfg, tc0, ioutfg: ",toutfg, tc0, ioutfg
             if (toutfg.lt.tc0) then
                write(45,*) "+++writing fixed grid"
