...
#------------------------------
    ...
    if clawdata.outstyle==1:
        ...
        clawdata.nout = 14 ## Number of frames (plus the t = 0.0 frame)
        clawdata.tfinal = 14*60  ## End run time in Seconds
...
#-------------------
  ...
  # == setdtopo.data values ==
    ...
    geodata.regions.append([5, 5, 180., 1e9, 139.453,139.49,42.05,42.068]) ## Hamatsumae
    ...
    geodata.fixedgrids.append([240.0,16*60.,25,139.453,139.49,42.05,42.068,200,200,0,1]) ## Aonae Peninsula Runup
