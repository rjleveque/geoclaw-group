...
#------------------------------
    ...
    if clawdata.outstyle==1:
        ...
        clawdata.tout =  [35.0, 40.0, 45.0, 50.0, 55.0, 60.0, 65.0, 70.0, 120.0]   # used if outstyle == 2
...
#-------------------
    ...
    geodata.topofiles.append([2, 1, 1, 0., 1.e10, 'beach.topotype2'])
    ...
    geodata.gauges = []
    geodata.gauges.append([1,0.25,0,0,120])
    geodata.gauges.append([2,9.95,0,0,120])
